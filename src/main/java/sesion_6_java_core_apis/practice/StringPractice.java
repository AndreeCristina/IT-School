package sesion_6_java_core_apis.practice;
...
//        System.out.println(isStringStartingWith("Hello", "Hel"));
...
//        System.out.println(getTrimmedString("     Bogdan    "));
    ...
    public static boolean isStringEndingWith(String input, String endWith) {
        return input.endsWith(endWith);
    }
