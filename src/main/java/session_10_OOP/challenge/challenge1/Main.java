...
public class Main {
    ...
    public static void main(String[] args) {
        Student s1 = new Student("Maria", "Nedelcu", Gender.F, LocalDate.of(1989, 4, 7),
        ...
        Course math = new Course(new Schedule(Weekday.MONDAY, LocalTime.of(10, 0), LocalTime.of(10, 50)), "50 minute", "Math", "online", professor1);
        Course computerScience = new Course(new Schedule(Weekday.MONDAY, LocalTime.of(11, 0), LocalTime.of(11, 50)), "50 minute", "Computer Science", "hybrid", professor4);
        Course physics = new Course(new Schedule(Weekday.TUESDAY, LocalTime.of(9, 0), LocalTime.of(9, 50)), "50 minute", "Physics", "hybrid", professor3);
        Course chemistry = new Course(new Schedule(Weekday.TUESDAY, LocalTime.of(10, 0), LocalTime.of(10, 50)), "50 minute", "Chemistry", "hybrid", professor2);
        Course biology = new Course(new Schedule(Weekday.WEDNESDAY, LocalTime.of(8, 0), LocalTime.of(8, 50)), "50 minute", "Biology", "online", professor2);
        Course geography = new Course(new Schedule(Weekday.WEDNESDAY, LocalTime.of(9, 0), LocalTime.of(9, 50)), "50 minute", "Geography", "online", professor5);
        Course english = new Course(new Schedule(Weekday.THURSDAY, LocalTime.of(8, 0), LocalTime.of(8, 50)), "50 minute", "English", "online", professor6);
        Course history = new Course(new Schedule(Weekday.THURSDAY, LocalTime.of(9, 0), LocalTime.of(9, 50)), "50 minute", "History", "online", professor7);
